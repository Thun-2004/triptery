            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Chilling Beach at Samui', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                    Row(
                      children: [
                        Icon(LucideIcons.mapPin, size: 16, color: Colors.white),
                        Text('Ko Samui, Surat', style: TextStyle(fontSize: 14, color: Colors.white)), //first province in the trip
                    ...
                    Row(
                      children : [
                        ...
                        Text('14 May - 17 May 2025 - 4 days', style: TextStyle(color: Colors.white))
                      ]
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('Couple Trip Cheap budget', style: TextStyle(color: Colors.white))
                      ],
                    ),
                  ],
                ),
