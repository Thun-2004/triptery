...
//TODO : AnimatedContainer, DropDown2, use contentPadding, Textformfield
class RouteDropdown extends StatefulWidget {
  RouteDropdown({super.key, required this.choices});

  final List<Map<String, dynamic>> choices;
  // Map<String, dynamic> pastChoice;
...
class _RouteDropdownState extends State<RouteDropdown> {
  var selected = 0;
  bool isSelected = false;
  late Map<String, dynamic>? currentChoiceOverview;
  late List<Map<String, dynamic>> currentChoiceDetails;
  final transportModeController = Get.find<TransportModeController>();
  final tripController = Get.find<TripController>();
  List<Map<String, dynamic>> get routeSegmentsDetail =>
      tripController.routeSegments_temp;
  late final List<Map<String, dynamic>> routeChoicesOverview;
  ...
  void initState() {
    super.initState();
    routeChoicesOverview = widget.choices;
    currentChoiceOverview = routeChoicesOverview.firstWhereOrNull(
      (choice) => choice["isSelected"] == true,
    );
    currentChoiceDetails =
        routeSegmentsDetail
            .where(
              (segment) => segment["optionId"] == currentChoiceOverview?["id"],
            )
            .toList();
  ...
  Widget build(BuildContext context) {
    final routesToDisplay =
        routeChoicesOverview.isNotEmpty ? routeChoicesOverview : [];
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    CustomText(
                      text: "${currentChoiceOverview?["total_time"]} mins",
                      type: TextType.body,
                      color: isSelected ? AppColors.white : AppColors.black,
                    ),
                    Text(
                      "${currentChoiceOverview?["total_distance"]} km - ${currentChoiceOverview?["total_cost"]} THB",
                      style: TextStyle(
                        color: isSelected ? AppColors.white : AppColors.black,
                        fontSize: 10,
                      ),
          ...
          child: Column(
            ...
            children: [
              if (routesToDisplay.isEmpty)
                ...
                //                     CustomText(
                //                       text:
                //                           "${transportModeController.calcTotalTime().toString()} min",
                //                       type: TextType.heading,
                //                       textSize: 12,
                //                       color: AppColors.black,
                //                     ),
                ...
                //                 true,
                //               );
                //               // widget.pastChoice = currentChoiceOverview;
                //             });
                //           },
                //         ),
                //       ),
              ...
              ...List.generate(routeChoicesOverview.length, (i) {
                Map<String, dynamic> routeChoiceOverview =
                    routeChoicesOverview[i];
                List<Map<String, dynamic>> routeChoiceDetails =
                    routeSegmentsDetail
                        .where(
                          (segment) =>
                              segment["optionId"] == routeChoiceOverview["id"],
                        )
                        .toList();
                  ...
                  children: [
                    ListTile(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  CustomText(
                                    text:
                                        "${routeChoiceOverview["total_time"]} mins",
                                    type: TextType.heading,
                                    textSize: 12,
                                    color: AppColors.black,
                                  ),
                                  Text(
                                    "${routeChoiceOverview["total_distance"]} km - ${routeChoiceOverview["total_cost"]} THB",
                                    style: TextStyle(
                                      color: AppColors.black,
                                      fontSize: 10,
                                    ),
                      ...
                      leading: Radio<int>(
                        ...
                        onChanged: (int? value) {
                          setState(() {
                            selected = value!;
                            currentChoiceOverview = routeChoiceOverview;
                            currentChoiceDetails =
                                routeSegmentsDetail
                                    .where(
                                      (segment) =>
                    ...
                    AnimatedContainer(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          buildTransportVerticalSequence(routeChoiceDetails),
                        ],
                      ),
                    ),
                  ],
                ...
                leading: Radio<int>(
                  ...
                  onChanged: (int? value) {
                    setState(() {
                      ...
                      // currentChoiceOverview = "Add Note"; // Update current choice to Google Maps
                      // widget.pastChoice = currentChoiceOverview;
                    });
                  },
                ),
